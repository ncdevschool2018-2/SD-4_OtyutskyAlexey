...
export class UserAccountsComponent implements OnInit{
  ...
  public editableUserAccount: UserAccount = new UserAccount();
  ...
  public _openModal(template: TemplateRef<any>, userAccount: UserAccount): void {
    ...
    console.log("Edit mode is %s.", this.editMode);

    if (userAccount) {
      this.editMode = true;
      this.editableUserAccount = UserAccount.cloneBase(userAccount);
    } else {
      this.refreshBa();
      this.editMode = false;
    }
  ...
  public _addUserAccount(): void {
    ...
    this.subscriptions.push(this.userAccountService.saveUserAccount(this.editableUserAccount).subscribe(() => {
  ...
  private refreshBa(): void {
    this.editableUserAccount = new UserAccount();
  }
