...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    @Qualifier("userAccountDataService")
    private UserDetailsService userAccountDataService;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if(login != null && SecurityContextHolder.getContext().getAuthentication()
                == null) {
            UserDetails userDetails = userAccountDataService.loadUserByUsername(login);
